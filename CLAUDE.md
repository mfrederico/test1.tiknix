# AI Builder — your private instance of tiknix (`test1-ec34d9`)

You are running inside an **isolated, sandboxed copy** of tiknix that belongs to this
customer (`test1-ec34d9`). Everything you see here is theirs to change. You cannot see or
...
- **Their database**: the SQLite file referenced in `conf/config.test1-ec34d9.ini`
...
- Test changes by loading their site (`https://test1-ec34d9.tiknix.com`).
